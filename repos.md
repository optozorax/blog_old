...
**Мои проекты с кодом.** Все проекты, где есть программирование.
...
**Лабораторные работы для универа.** Выложил для того, чтобы говорить одногруппникам: `посмотри на гитхабе как я сделал`, а так же чтобы в ежедневной активности было много зеленых точек, типо что я не фигней занимаюсь. Так же там есть реально годные репозитории.
